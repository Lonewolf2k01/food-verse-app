                    ...
                    <motion.div
                        ...
                        <div className="w-full flex items-center justify-between">
                            ...
                            <motion.div
                                ...
                                className='w-9 h-9 rounded-full bg-red-600 flex justify-center items-center cursor-pointer hover:shadow-xl hover:scale-125 active:scale-50 transition-transform ease-in-out duration-150'>
