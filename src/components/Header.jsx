            ...
            <div className="hidden md:flex w-full h-full items-center justify-between">
                ...
                <div className="flex items-center gap-8">
                    ...
                    <motion.div
                        ...
                        whileHover={{ scale: 1.15 }}
                        onClick={showCart}
                        className={`flex relative items-center justify-center active:scale-50`}>
                        <IoIosBasket className="text-textColor text-2xl hover:text-red-600 transition-all ease-in-out cursor-pointer " />
                        {
                    ...
                    <div className="relative active:scale-75 transition-all duration-100 ease-in-out">
                        <motion.img
                            whileHover={{ scale: 1.15 }}
